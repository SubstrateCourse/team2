...
mod tests {
	...
	impl balances::Trait for Test {
		...
		// type AccountStore = balances::AccountData<Balance>;
	}
	...
	type OwnedKittiesList = LinkedList<OwnedKitties<Test>, <Test as system::Trait>::AccountId, <Test as Trait>::KittyIndex>;
